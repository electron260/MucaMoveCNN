...
def train(model, device, train_loader, optimizer, epoch, criterion):
    ...
    wandb.log({"avg train acc:": accuracy, "epoch" : epoch})
...
def test(model, device, test_loader, criterion,epoch):
    ...
    wandb.log({"avg test acc:": accuracy, "epoch" : epoch})
...
def main():
    ...
    train_dataset = MyDataset("/home/hugo/Bureau/ARTICPROJECT/MucaMoveCNN/CNN/dataset/9x9",True)
    test_dataset = MyDataset("/home/hugo/Bureau/ARTICPROJECT/MucaMoveCNN/CNN/dataset/9x9",False)
    ...
    scheduler = torch.optim.lr_scheduler.StepLR(optimizer, step_size=35, gamma=0.1, last_epoch=-1)
    ...
    ax.set(xticks=np.arange(matrix.shape[1]),
            ...
            xticklabels=["slideleft" , "slideright", "slideup", "slidedown", "longtouch", "doubleslideleft", "doubleslideright", "doubleslideup", "doubleslidedown", "doublelongtouch"], yticklabels=["slideleft" , "slideright", "slideup", "slidedown", "longtouch", "doubleslideleft", "doubleslideright", "doubleslideup", "doubleslidedown", "doublelongtouch"],
            ylabel="True label",
...
if __name__ == '__main__':
 #open a file to read
    ...
    wandb.init(project="MucaMoveCNN", entity = "electron260")
    wandb.run.name = "CNN"
    wandb.config = {
  "epochs": 150,  
  "batch_size": 3
